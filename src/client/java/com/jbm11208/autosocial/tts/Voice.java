...
/**
 * All voice identifiers supported by the StreamElements TTS API.
 * The enum names match the original Python script for drop‑in compatibility.
 */
public enum Voice {
    Brian("Brian"),
    Amy("Amy"),
    ...
    Voice(String apiName) {
        this.apiName = apiName;
    }

    /** Returns the exact string expected by the StreamElements API. */
